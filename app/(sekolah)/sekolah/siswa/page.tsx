        ...
        <div className="space-y-6">
            <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Daftar murid sekolah Anda yang terdaftar di Robotiku.</p>
                </div>
            ...
            <Card className="overflow-hidden">
                ...
                <Table>
                    ...
                    <TableBody>
                        ...
                        {!q.isLoading && rows.length === 0 && (
                            <TableRow><TableCell colSpan={5} className="py-10 text-center text-muted-foreground">Belum ada siswa.</TableCell></TableRow>
                        )}
                ...
                {p && (
                    <div className="flex items-center justify-between border-t p-4 text-sm text-muted-foreground">
                        <span>Total {p.total} siswa · Halaman {p.current_page} dari {p.last_page}</span>
...
export default function Page() {
    return <SchoolShell><SiswaInner /></SchoolShell>;
}