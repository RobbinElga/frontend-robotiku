...
export function CircularText({ text = "MULAI•SEKARANG•ROBOTIKU•", size = 132 }: { text?: string; size?: number }) {
    ...
    return (
        <div className="animate-bob relative grid place-items-center rounded-full border-[3px] border-black bg-accent" style={{ width: size, height: size, boxShadow: "5px 5px 0 0 #000" }} aria-hidden="true">
